            ...
            <div class="card-body">
                <form action="{{route('berita.prosesUbah')}}" method="post" enctype="multipart/form-data">
                        ...
                        <select name="id_kategori_kegiatan"
                            ...
                            @foreach($kategori_kegiatan as $row)
                                <option value="{{ $row->id_kategori_kegiatan }}"
                                    {{ old('id_kategori_kegiatan', $berita->id_kategori_kegiatan) == $row->id_kategori_kegiatan ? 'selected' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        @enderror
                        <p></p>
                        <img id="tampilFoto" onerror="this.onerror=null;this.src='https://t4.ftcdn.net/jpg/84/73/25/49/360_F_473254957_bxG9yf4ly70B05I0O5KABlN9306GwaMQz.jpg';" src="{{route('storage',$berita->gambar_berita)}}" alt="" width="15%">
                    </div>
