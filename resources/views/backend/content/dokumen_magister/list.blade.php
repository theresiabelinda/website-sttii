    ...
    <div class="container-fluid content-wrapper">
        <div class="card shadow-sm border-0">
            <div class="card-header d-flex justify-content-between align-items-center bg-white py-3">
                <h4 class="mb-0 font-weight-bold text-primary">Data Dokumen Prodi S2</h4>
                            ...
                            @foreach($data as $key => $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('storage.magister_view', ['path' => $item->path_file]) }}" target="_blank" class="btn btn-sm btn-info text-white rounded-pill px-3">
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group" role="group">
                                            ...
                                            <a href="{{ route('dokumen_magister.hapus', $item->id) }}"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content border-0">
                            ...
                            <div class="modal-body">
                                <form method="POST" action="{{ route('dokumen_magister.prosesTambah') }}" enctype="multipart/form-data">
                                    @csrf
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            editButtons.forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    formEdit.action = `{{ route('dokumen_magister.prosesUbah') }}`;
                });
            });
        });
    </script>
