...
@section('content')
    ...
    <div class="container-fluid page-header py-6 my-6 mt-0 wow fadeIn" data-wow-delay="0.1s"
        ...
        <div class="container text-center">
            <h1 class="display-4 text-white animated slideInDown mb-4">Profil Prodi Magister (S2)</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    ...
                    <li class="breadcrumb-item text-primary active" aria-current="page">Profil S2</li>
                </ol>
            </nav>
        </div>
    </div>
                            ...
                            <ul class="list-unstyled mb-0">
                                <li class="mb-3 d-flex align-items-start">
                                    ...
                                    <div>
                                        ...
                                        <div class="fw-bold text-dark">Magister Teologi (M.Th.)</div>
                                    </div>
                                </li>
                                <li class="mb-3 d-flex align-items-start">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-dark">10576/SK/BAN-PT/Akred/M/VIII/2021</div>
                                    </div>
                                </li>
                                <li class="mb-3 d-flex align-items-start">
                                ...
                                <li class="d-flex align-items-start">
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            <a href="mailto:sttiiadak@gmail.com" class="text-dark d-block">mth.sttii@gmail.com</a>
