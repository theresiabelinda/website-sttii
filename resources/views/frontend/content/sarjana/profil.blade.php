...
@section('content')
    ...
    <div class="container-fluid page-header py-6 my-6 mt-0 wow fadeIn" data-wow-delay="0.1s"
        ...
        <div class="container text-center">
            <h1 class="display-4 text-white animated slideInDown mb-4">Profil Prodi Sarjana (S1)</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    ...
                    <li class="breadcrumb-item text-primary active" aria-current="page">Profil S1</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-5 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="position-relative h-auto mb-4">
                        {{-- Gambar Utama --}}
                        <img class="img-fluid rounded w-100 shadow-sm" src="{{ asset('assets-fe/img/fotos1.jpeg') }}" alt="Kegiatan Mahasiswa S1" style="object-fit: cover; min-height: 350px;">

                        {{-- SAYA MENGHAPUS DIV 'KOTAK PUTIH KIRI ATAS' DISINI --}}

                        {{-- Label 'Sejak 1979' (Kanan Bawah) --}}
                            ...
                            <ul class="list-unstyled mb-0">
                                <li class="mb-3 d-flex align-items-start">
                                    ...
                                    <div>
                                        ...
                                        <div class="fw-bold text-dark">Sarjana Teologi (S.Th.)</div>
                                    </div>
                                </li>
                                <li class="mb-3 d-flex align-items-start">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-dark">3818/SK/BAN-PT/Ak.Ppj/S/IX/2023</div>
                                    </div>
                                </li>
                                <li class="mb-3 d-flex align-items-start">
                                ...
                                <li class="d-flex align-items-start">
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            <a href="mailto:sttiiadak@gmail.com" class="text-dark d-block">sttiiadak@gmail.com</a>
                                            <a href="https://wa.me/6281326882170" target="_blank" class="text-primary fw-bold">0813-2688-2170 (WA)</a>
                                        </div>
                                    </div>
                                </li>
                            </ul>
