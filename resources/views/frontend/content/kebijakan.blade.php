...
@section('content')
    ...
    <div class="container-fluid page-header py-6 my-6 mt-0 wow fadeIn" data-wow-delay="0.1s"
        ...
        <div class="container text-center">
            <h1 class="display-4 text-white animated slideInDown mb-4">Kebijakan & Dokumen</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    <li class="breadcrumb-item"><a class="text-white" href="{{ route('home.index') }}">Home</a></li>
                    <li class="breadcrumb-item text-primary active" aria-current="page">Kebijakan</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="text-center mx-auto mb-5" style="max-width: 700px;">
                        ...
                        <h1 class="display-6 mb-4">Kebijakan SPMI</h1>
                        <p class="text-secondary">Standar Penjaminan Mutu Internal</p>
                    </div>
                </div>
                ...
                <div class="col-lg-10 mx-auto wow fadeInUp" data-wow-delay="0.3s">
                    <div class="bg-light rounded p-4 p-md-5 shadow-sm">
                        ...
                        <div class="d-flex justify-content-center mt-4">
                            {{ $kebijakan->links('pagination::bootstrap-5') }}
                        </div>
